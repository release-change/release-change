...
import * as mockedGetBranchName from "../../src/git/get-branch-name.js";
...
describe("check branch", () => {
  ...
  it("should return `false` if the branch name is undefined", async () => {
    vi.spyOn(mockedGetBranchName, "default").mockReturnValue(undefined);
    expect(checkBranch(mockedContext)).toBe(false);
  });
  it('should return `false` if the branch name is `"non-eligible-branch"`', () => {
    vi.spyOn(mockedGetBranchName, "default").mockReturnValue("non-eligible-branch");
    expect(checkBranch(mockedContext)).toBe(false);
  });
  it('should return `undefined` if the branch name is `"main"`', () => {
    vi.spyOn(mockedGetBranchName, "default").mockReturnValue("main");
