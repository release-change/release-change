...
**Full changelog:** [`@release-change/config@v0.2.1...@release-change/config@v0.3.0`](https://github.com/release-change/release-change/compare/@release-change/config@v0.2.1...@release-change/config@v0.3.0)
...
**Full changelog:** [`@release-change/config@v0.1.2...@release-change/config@v0.1.3`](https://github.com/release-change/release-change/compare/@release-change/config@v0.1.2...@release-change/config@v0.1.3)
...
**Full changelog:** [`@release-change/config@v0.1.1...@release-change/config@v0.1.2`](https://github.com/release-change/release-change/compare/@release-change/config@v0.1.1...@release-change/config@v0.1.2)
