...
/**
 * Checks whether the version is less than all the versions within the range.
 ...
 * @return `true` if the version is less than all the versions within the range, `false` otherwise.
 */
export const ltRange = (
