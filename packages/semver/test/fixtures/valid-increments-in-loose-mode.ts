...
export const validIncrementsInLooseMode: {
  version: string;
  ...
  {
    version: "v1.2.3-alpha.10.0.beta",
    releaseType: "prerelease",
    expected: {
  ...
  {
    version: "v1.2.3-alpha.10.1.beta",
    releaseType: "prerelease",
    expected: {
  ...
  {
    version: "v1.2.3-alpha.10.2.beta",
    releaseType: "prerelease",
    expected: {
  ...
  {
    version: "v1.2.3-alpha.10.beta.0",
    releaseType: "prerelease",
    expected: {
  ...
  {
    version: "v1.2.3-alpha.10.beta.1",
    releaseType: "prerelease",
    expected: {
  ...
  {
    version: "v1.2.3-alpha.10.beta.2",
    releaseType: "prerelease",
    expected: {
