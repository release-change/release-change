export const validVersions = [
  {
    raw: "1.0.0",
    version: "1.0.0",
    expected: { major: 1, minor: 0, patch: 0, prerelease: [], build: [] }
  },
  {
    raw: "2.1.0",
    version: "2.1.0",
    expected: { major: 2, minor: 1, patch: 0, prerelease: [], build: [] }
  },
  {
    raw: "3.2.1",
    version: "3.2.1",
    expected: { major: 3, minor: 2, patch: 1, prerelease: [], build: [] }
  },
  {
    raw: "1.2.3-0",
    version: "1.2.3-0",
    expected: { major: 1, minor: 2, patch: 3, prerelease: [0], build: [] }
  },
  {
    raw: "1.2.3-123",
    version: "1.2.3-123",
    expected: { major: 1, minor: 2, patch: 3, prerelease: [123], build: [] }
  },
  {
    raw: "1.2.3-1.2.3",
    version: "1.2.3-1.2.3",
  ...
  },
  {
    raw: "1.2.3-1a",
    version: "1.2.3-1a",
    expected: { major: 1, minor: 2, patch: 3, prerelease: ["1a"], build: [] }
  },
  {
    raw: "1.2.3-a1",
    version: "1.2.3-a1",
    expected: { major: 1, minor: 2, patch: 3, prerelease: ["a1"], build: [] }
  },
  {
    raw: "1.2.3-alpha",
    version: "1.2.3-alpha",
  ...
  },
  {
    raw: "1.2.3+456",
    version: "1.2.3",
    expected: { major: 1, minor: 2, patch: 3, prerelease: [], build: ["456"] }
  },
  {
    raw: "1.2.3+build",
    version: "1.2.3",
