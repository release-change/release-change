...
- @release-change/get-packages@0.3.2
- @release-change/git@0.4.2
- @release-change/github@0.4.2
- @release-change/npm@0.3.2
- @release-change/release-notes-generator@0.4.2

---

**Full changelog:** [`@release-change/release@v0.5.1...@release-change/release@v0.5.2`](https://github.com/release-change/release-change/compare/@release-change/release@v0.5.1...@release-change/release@v0.5.2)
...
- @release-change/npm@0.3.1
- @release-change/release-notes-generator@0.4.1

---

**Full changelog:** [`@release-change/release@v0.5.0...@release-change/release@v0.5.1`](https://github.com/release-change/release-change/compare/@release-change/release@v0.5.0...@release-change/release@v0.5.1)
...
- @release-change/npm@0.3.0
- @release-change/release-notes-generator@0.4.0
- @release-change/shared@0.3.0

---

**Full changelog:** [`@release-change/release@v0.4.4...@release-change/release@v0.5.0`](https://github.com/release-change/release-change/compare/@release-change/release@v0.4.4...@release-change/release@v0.5.0)
...
- @release-change/npm@0.2.2
- @release-change/release-notes-generator@0.3.4

---

**Full changelog:** [`@release-change/release@v0.4.3...@release-change/release@v0.4.4`](https://github.com/release-change/release-change/compare/@release-change/release@v0.4.3...@release-change/release@v0.4.4)

## 0.4.3

### Dependencies updates

- @release-change/github@0.3.3
- @release-change/release-notes-generator@0.3.3

---

**Full changelog:** [`@release-change/release@v0.4.2...@release-change/release@v0.4.3`](https://github.com/release-change/release-change/compare/@release-change/release@v0.4.2...@release-change/release@v0.4.3)

## 0.4.2

### Dependencies updates

- @release-change/github@0.3.2
- @release-change/release-notes-generator@0.3.2

---

**Full changelog:** [`@release-change/release@v0.4.1...@release-change/release@v0.4.2`](https://github.com/release-change/release-change/compare/@release-change/release@v0.4.1...@release-change/release@v0.4.2)
...
- @release-change/git@0.3.1
- @release-change/github@0.2.1
- @release-change/npm@0.2.1
- @release-change/release-notes-generator@0.2.1

---

**Full changelog:** [`@release-change/release@v0.3.0...@release-change/release@v0.3.1`](https://github.com/release-change/release-change/compare/@release-change/release@v0.3.0...@release-change/release@v0.3.1)
...
- @release-change/npm@0.1.3
- @release-change/release-notes-generator@0.1.6
- @release-change/shared@0.1.3

---

**Full changelog:** [`@release-change/release@v0.2.0...@release-change/release@v0.2.1`](https://github.com/release-change/release-change/compare/@release-change/release@v0.2.0...@release-change/release@v0.2.1)
...
- @release-change/release-notes-generator@0.1.4

---

**Full changelog:** [`@release-change/release@v0.1.4...@release-change/release@v0.1.5`](https://github.com/release-change/release-change/compare/@release-change/release@v0.1.4...@release-change/release@v0.1.5)
