...
const breakingChangeCommitForAnotherPackage = {
  isMergeCommit: false,
  sha: "d652880132e1100d4c8cf6a3540019b7b094fcf3",
...
const featCommitForAnotherPackage = {
  isMergeCommit: false,
...
const fixCommitForAnotherPackage = {
  isMergeCommit: false,
...
export const mockedMajorLevelParsedCommitsInMonorepo: Commit[] = [
...
export const mockedMinorLevelParsedCommitsInMonorepo: Commit[] = [
  featMergeCommit,
  testCommit1,
  refactorCommit1,
  testCommit2,
...
export const mockedPatchLevelParsedCommitsInMonorepo: Commit[] = [
  fixMergeCommit,
  testCommit1,
  refactorCommit1,
  testCommit2,
