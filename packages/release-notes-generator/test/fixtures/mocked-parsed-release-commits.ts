const mockedFooterKey = "Co-authored-by";
const mockedBotEmail = "0+mocked-committer-name-bot@users.noreply.github.com";
const mockedBotName = "mocked-committer-name [bot]";
const mockedFooterValue = `${mockedBotName} <${mockedBotEmail}>`;
const mockedFooter = `${mockedFooterKey}: ${mockedFooterValue}`;
