  ...
  vi.spyOn(fs, "readdir").mockImplementation(async dirPath => {
    if (dirPath === mockedCwd) {
      return [
        {
          ...mockedDirent,
          name: "directory1" as unknown as Buffer<ArrayBufferLike>,
          isDirectory: () => true,
        ...
        {
          ...mockedDirent,
          name: "directory2" as unknown as Buffer<ArrayBufferLike>,
          isDirectory: () => true,
          parentPath: mockedCwd,
    ...
    if (dirPath === "/fake/cwd/directory1") {
      return [
        {
          ...mockedDirent,
          name: "subdirectory1" as unknown as Buffer<ArrayBufferLike>,
          isDirectory: () => true,
    ...
    if (dirPath === "/fake/cwd/directory2") {
      return [
        {
          ...mockedDirent,
          name: "subdirectory2" as unknown as Buffer<ArrayBufferLike>,
          isDirectory: () => true,
