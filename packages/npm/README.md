...
Functions used internally in release-change to publish packages to NPM
...
![NPM latest version](https://img.shields.io/npm/v/%40release-change%2Fnpm/latest)
![Node support](https://img.shields.io/node/v/%40release-change%2Fnpm)
